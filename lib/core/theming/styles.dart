...
import 'package:medisync/core/theming/font_weight_helper.dart';
...
class TextStyles {
  ...
  static TextStyle font24BlackBlue = TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeightHelper.bold,
  ...
  static TextStyle font12BlackGrayMeduim = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.meduim,
    color: ColorsManager.blackGray,
  );

  static TextStyle font12BlackGrayRegular = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.blackGray,
  );

  static TextStyle font11BlackGrayRegular = TextStyle(
    fontSize: 11.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.blackGray,
  );
